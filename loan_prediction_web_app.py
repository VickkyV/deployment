...
loaded_model = pickle.load(open(r"C:\Users\USER\Desktop\Gomycode\loan_prediction_model_v2.pkl", "rb"))
...
def main():
    ...
    if st.button("Loan status"):
        performance = loan_prediction(
            ...
            loan_amount, loan_amount_term, dependent_1, dependents_2,
            dependents_3, credit_history, property_area_Semiurban, property_area_Urban])
